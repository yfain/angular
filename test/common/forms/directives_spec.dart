library angular2.test.common.forms.directives_spec;
  ...
  describe("Form Directives", () {
    ...
    describe("shared", () {
      describe("selectValueAccessor", () {
        NgControl dir;
        beforeEach(() {
          dir = (new SpyNgControl() as dynamic);
        });
        ...
        it("should throw when more than one custom accessor is provided", () {
          ControlValueAccessor customAccessor =
              (new SpyValueAccessor() as dynamic);
          expect(() =>
                  selectValueAccessor(dir, [customAccessor, customAccessor]))
              .toThrowError();
        });
      });
    ...
    describe("NgFormModel", () {
      ...
      describe("addControlGroup", () {
        ...
        it("should set up validator", fakeAsync(() {
          ...
          // sync validators are set
          expect(formModel.hasError("differentPasswords", ["passwords"]))
              .toEqual(true);
          ((formModel.find(["passwords", "passwordConfirm"]) as Control))
              .updateValue("somePassword");

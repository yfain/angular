library angular2.test.compiler.output.path_util_spec;
  ...
  describe("PathUtils", () {
    describe("getImportModulePath", () {
      it("should calculate relative paths for JS and Dart", () {
        expect(getImportModulePath("asset:somePkg/lib/modPath",
      ...
      it("should calculate relative paths for different constellations", () {
        expect(getImportModulePath("asset:somePkg/test/modPath",

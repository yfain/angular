...
commonTests() {
  ...
  describe("run", () {
    ...
    it(
        ...
        testTimeout);
    it(
        "should not allow onEventDone to cause further digests",
        inject([AsyncTestCompleter], (async) {
          _zone.overrideOnTurnStart(null);
          var eventDone = false;
          _zone.overrideOnEventDone(() {
  ...
  describe("exceptions", () {
    ...
    it(
        ...
        testTimeout);
    it(
        "should call onError when onTurnDone throws and the zone is sync",
        inject([AsyncTestCompleter], (async) {
        ...
        testTimeout);
    it(
        "should call onError when onTurnDone throws and the zone is async",
        inject([AsyncTestCompleter], (async) {
          var asyncRan = false;
          var exception = new BaseException("fromOnTurnDone");
          _zone.overrideOnErrorHandler(logError);

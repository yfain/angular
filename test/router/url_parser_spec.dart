library angular2.test.router.url_parser_spec;
...
import "package:angular2/testing_internal.dart"
    show
        ...
        beforeEach,
        SpyObject;
import "package:angular2/src/router/url_parser.dart" show UrlParser, Url;
...
main() {
  describe("ParsedUrl", () {
    ...
    it("should parse a route with matrix and query params", () {
      var url =
          urlParser.parse("hello/there;sort=asc;unfiltered?hi&friend=true");
      expect(url.toString())
          .toEqual("hello/there;sort=asc;unfiltered?hi&friend=true");
    });

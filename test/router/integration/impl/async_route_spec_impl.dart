library angular2.test.router.integration.impl.async_route_spec_impl;
...
asyncRoutesWithoutChildrenWithRouteData() {
  ...
  it(
      "should inject route data into the component",
      ...
      inject([AsyncTestCompleter], (async) {
        compile(tcb, '''outer { <router-outlet></router-outlet> }''')
            ...
            .then((_) => rtr.config([
                  new AsyncRoute(
                      path: "/a/...",
                      loader: parentWithDefaultCmpLoader,
                      name: "Parent")
                ]))
      ...
      inject([AsyncTestCompleter], (async) {
        compile(tcb, '''outer { <router-outlet></router-outlet> }''')
            ...
            .then((_) => rtr.config([
                  new AsyncRoute(
                      path: "/a/...",
                      loader: asyncDefaultParentCmpLoader,
                      name: "Parent")
                ]))
            .then((_) => rtr.navigateByUrl("/a"))
            .then((_) {
...
registerSpecs() {
  specs["asyncRoutesWithoutChildrenWithRouteData"] =
      asyncRoutesWithoutChildrenWithRouteData;
  specs["asyncRoutesWithoutChildrenWithoutParams"] =
      asyncRoutesWithoutChildrenWithoutParams;
  specs["asyncRoutesWithoutChildrenWithParams"] =
      asyncRoutesWithoutChildrenWithParams;
